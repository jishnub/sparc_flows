...
ax=plotc.quiver2D(vx,vz,x=x,y=z,every=[2,3],xr=[-Lx/6,Lx/6],yr=[-5,None],
scale=8000,key=True,key_properties={'suffix':' m/s'},rasterized=False,color='#777777')
...
rec_x=18
plt.plot([rec_x],[excite_depth],'go',markersize=12)

ax.text(src_x,0.2,"Source",horizontalalignment='center',verticalalignment='bottom',
        fontsize=16)
        
ax.text(rec_x,0.2,"Receiver",horizontalalignment='center',verticalalignment='bottom',
        fontsize=16)
