...
def grad_command(algo="cg",eps=[0.01*i for i in range(1,num_linesearches+1)]):
            ...
            if str(iterno) in iters_list:
                ...
                if prev1_done:
                    ...
                    if ls_details[0].any():
                        ...
                        print("No step size information recorded", end=' ')
                ...
                print("Linesearch for this iteration not done yet, choosing step size from iteration", end=' ')
